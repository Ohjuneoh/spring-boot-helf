			...
			<div class="text-center">
				...
				<div class="text-start" style="margin: 0 auto; width:850px;">
					<div class="card card-body bg-light border-0" 
						...
						1.1.1 헬스장 이용은 회원 등록 후에 가능합니다. 회원 등록 시 제출한 개인정보는 개인정보보호정책에 따라 철저히 보호되며, 무단으로 타인과 공유되지 않습니다.
						1.1.2 회원은 개인정보의 정확성을 유지해야 하며, 변경 시 즉시 헬스장에 통보해야 합니다.
						<strong style="margin-top: 10px;">
							1.2 시설 안전 및 규칙
						</strong>
						1.2.1 헬스장 내의 시설과 장비를 안전하게 이용하기 위해 회원은 규칙과 지침을 준수해야 합니다.
						1.2.2 회원은 운동 전에 충분한 워밍업을 하고, 체력과 능력에 맞는 강도 및 무게로 운동을 진행해야 합니다.
						1.2.3 시설 내 안전을 위해 금속 물품 및 위험한 물질의 사용은 제한될 수 있습니다.
						1.2.4 헬스장은 회원의 안전을 위해 감독 및 보조 지침을 제공할 수 있습니다. 회원은 이를 지켜야 합니다.
						<strong style="margin-top: 10px;">
							1.3 시설 이용시간 및 예약
						</strong>
						1.3.1 헬스장 운영시간은 매일 일정한 시간대에 한정됩니다. 휴무일 및 휴무기간에 관한 정보는 사이트나 공지판에서 확인하실 수 있습니다.
						1.3.2 일부 시설이나 프로그램은 사전 예약이 요구될 수 있습니다. 예약 시간을 지켜 이용해주시기 바랍니다.
					</div>
				...
				<div class="text-start" style="margin: 0 auto; width:850px;">
					<div class="card card-body bg-light border-0" 
						...
						2.1.1 이용권 구매 후 환불을 원하실 경우, 구매 후 일정 기간 내에 환불 요청을 하셔야 합니다. 각 이용권 상품마다 환불 가능 기간이 다를 수 있습니다.
						2.1.2 환불 요청 시에는 반드시 구매 영수증 또는 이용권 코드를 제시해야 합니다.
						<strong style="margin-top: 10px;">
							2.2 본인 확인 및 환불 수수료
						</strong>
						2.2.1 환불 요청 시에는 회원 본인임을 확인하기 위한 절차가 진행될 수 있습니다.
						2.2.2 환불 시에는 환불 수수료가 부과될 수 있습니다. 환불 수수료는 환불 금액에서 공제되며, 환불 수수료의 정확한 금액은 이용약관에 명시됩니다.
						<strong style="margin-top: 10px;">
							2.3 부분 환불
						</strong>
						2.3.1 이용권 중 일부만 사용하고 남은 부분을 환불하고자 할 경우, 사용한 일 수에 따라 일부 금액이 차감되어 환불될 수 있습니다.
						<strong style="margin-top: 10px;">
							2.4 환불 처리 기간
						</strong>
							2.4.1 환불 요청이 접수된 후 환불 처리는 일반적으로 5-10일 정도 소요될 수 있습니다.
					</div>
					<label style="margin-top: 30px;">
