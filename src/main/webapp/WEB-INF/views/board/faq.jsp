...
<body>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
			...
			<div class="container mt-3">
				<h4>자주 찾는 도움말</h4><br>
				  ...
				  <ul class="nav nav-pills" role="tablist">
				    ...
				    <li class="nav-item">
				      <a class="nav-link" data-bs-toggle="pill" href="#menu1">사이트 이용</a>
				    </li>
				    <li class="nav-item">
				      <a class="nav-link" data-bs-toggle="pill" href="#menu2">수업</a>
				    </li>
				  </ul>
			...
			<div class="more-button d-flex justify-content-center align-items-center mt-3" >
