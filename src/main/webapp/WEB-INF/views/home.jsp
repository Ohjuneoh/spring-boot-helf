            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">24시간 연중무휴 통합 회원권 </h1>
                    </div>
                    <p class="mb-4">전국 최대규모의 헬스장을 전국 최저가격으로 최고의 혜택을 제공합니다.</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>24시간 365일 연중무휴 </h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>합리적인 회원권 금액</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>야간에도 안전한 보안경비 시스템</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>실내 적정온도 상시유지</h5>
                        </div>
                    </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s" src="/resources/img/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="row g-5">
        ...
        <div class="container py-5 mb-5">
            <div class="bg-white">
                <div class="owl-carousel vendor-carousel">
                    ...
                    <img src="/resources/img/vendor-9.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
