						...
						<div class="collapse" id="collapseExample">
							...
							<div class="container">
								<div class="row">
									<div class="col-md-6">
								  	...
								  	<div class="col-md-6">
										<div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0" style="max-height: 200px; overflow-y: auto; padding: 10px; border: 1px solid white;">
							...
							<label>
								...
								<div class="row">
									<div class="col-md-6">
											<div id="list-example" class="list-group">
											  <a class="list-group-item list-group-item-action" href="#list-item-1">1. 수집하는 개인정보</a>
											  <a class="list-group-item list-group-item-action" href="#list-item-2">2. 수집한 개인정보의 이용</a>
											  <a class="list-group-item list-group-item-action" href="#list-item-3">3. 개인정보의 보관기간</a>
											  <a class="list-group-item list-group-item-action" href="#list-item-4">4. 개인정보 수집 및 이용 동의를 거부할 권리</a>
											</div>
									</div>
								  	<div class="col-md-6">
										<div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0" style="max-height: 200px; overflow-y: auto; padding: 10px; border: 1px solid white;">
										  <h4 id="list-item-1">1. 수집하는 개인정보</h4>
										  ...
										  <h4 id="list-item-2">2. 수집한 개인정보의 이용</h4>
										  ...
										  <h4 id="list-item-3">3. 개인정보의 보관기간</h4>
										  ...
										  <h4 id="list-item-4">4. 개인정보 수집 및 이용 동의를 거부할 권리</h4>
